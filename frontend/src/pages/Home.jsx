...
const Home = () => {
  ...
  return (
    <>
      <section
        className={` p-4 rounded hero__section dark:bg-slate-900 pt-[60px] 2xl:h-[750px]`}
      >
          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                <h1 className="text-[36px] leading-[26px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]">
                  We help patients live a healthy,longer life.
                </h1>

                <p className="text__para">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Quaerat numquam tempore corrupti, veniam reiciendis magni!
                  Quos quisquam deserunt facere sed aperiam non
                </p>
      ...
      <section>
        <div className="container">
          <div className="flex justify-between gap-[50px] lg:gap-0">
            <div>
              <img src={faqImg} className="w-1/2 hidden md:block" alt="" />
            </div>
