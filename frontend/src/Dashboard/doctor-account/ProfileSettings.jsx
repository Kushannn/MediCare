  ...
  return (
    <div>
      ...
      <form action="">
        ...
        <div className="mb-5">
          <h4 className="text-headingColor font-bold text-[20px] leading-6 mb-8">
            Qualifications
          </h4>
            ...
            <div key={index}>
              <div>
                ...
                <button
                  ...
                  className="bg-red-600 p-2 rounded-full text-white text-[18px] mt-2 b-[30px] cursor-pointer"
                >
                  <AiOutlineDelete />
                </button>
              </div>
            ...
            <div key={index}>
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px]  gap-5">
                  ...
                  >
                    <button className="bg-red-600 p-2 rounded-full text-white text-[18px] mt-6 b-[30px] cursor-pointer">
                      <AiOutlineDelete />
                    </button>
                  </div>
                </div>
